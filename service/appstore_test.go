...
func TestGetComposeApp(t *testing.T) {
	...
	appStore, err := service.AppStoreByURL("https://github.com/Vioneta/_appstore/archive/refs/heads/main.zip")
	assert.NilError(t, err)
...
func TestWorkDir(t *testing.T) {
	...
	// test for github
	hostname := "github.com"
	path := "/Vioneta/VionetaOS-AppStore/archive/refs/heads/main.zip"
...
func TestStoreRoot(t *testing.T) {
	...
	expectedStoreRoot := filepath.Join(workdir, "github.com", "Vioneta", "VionetaOS-AppStore", "main")

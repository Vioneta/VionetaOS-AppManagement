...
readonly CASA_EXEC=vionetaos-app-management
readonly CASA_CONF=/etc/vionetaos/app-management.conf
readonly CASA_DB=/var/lib/vionetaos/db/app-management.db

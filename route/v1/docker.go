...
import (
	...
	"github.com/Vioneta/VionetaOS-Common/utils/ssh"
...
const (
	dockerRootDirFilePath             = "/var/lib/vionetaos/docker_root"
...
func MyAppList(c *gin.Context) {
	...
	data["vionetaos_apps"] = casaOSApps
...
func pullAndInstall(ctx context.Context, imageName string, m *model.CustomizationPostData) error {
	...
	config.VionetaOSGlobalVariables.AppChange = true
	return nil
}

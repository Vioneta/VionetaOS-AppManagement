...
import (
	...
	v2 "github.com/Vioneta/VionetaOS-AppManagement/route/v2"
...
func TestFilterCatalogByCategory(t *testing.T) {
	...
	catalog["test"] = &service.ComposeApp{
		Extensions: map[string]interface{}{
			common.ComposeExtensionNameXVionetaOS: map[string]interface{}{
				"category": "test",
			},
		},
	}
...
func TestFilterCatalogByAuthorType(t *testing.T) {
	...
	filteredCatalog = v2.FilterCatalogByAuthorType(catalog, codegen.ByVionetaos)
	assert.Equal(t, len(filteredCatalog), 0)
	...
	catalog["test"] = &service.ComposeApp{
		Extensions: map[string]interface{}{
			common.ComposeExtensionNameXVionetaOS: map[string]interface{}{
				"author": common.ComposeAppAuthorVionetaOSTeam,
			},
		},
	}

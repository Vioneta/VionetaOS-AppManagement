...
const (
	appManagementConfigDirPath  = "/etc/vionetaos"
	appManagementConfigFilePath = "/etc/vionetaos/app-management.conf"
	appManagementName           = "vionetaos-app-management.service"
	appManagementNameShort      = "app-management"
)

//go:embedded ../../build/sysroot/etc/vionetaos/app-management.conf.sample
